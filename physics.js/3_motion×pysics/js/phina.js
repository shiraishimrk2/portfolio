...
(function () {
   ...
   * @return {Number} 最大値
   */
  Number.prototype.$method("max", function (value) {
   ...
   * @return {Number} 最小値
   */
  Number.prototype.$method("min", function (value) {
   ...
   */
  Number.prototype.$method("clamp", function (min, max) {
   ...
   */
  Number.prototype.$method("pow", function (exponent) {
...
(function () {
  ...
  phina.input.Mouse.prototype.getPointing = function () {
    return this.getButton("left");
  };
  phina.input.Mouse.prototype.getPointingStart = function () {
    return this.getButtonDown("left");
  };
  phina.input.Mouse.prototype.getPointingEnd = function () {
  ...
  phina.define('phina.app.Object2D', {
    ...
    _accessor: {
      ...
      top: {
        ...
        "set": function (v) {
          this.y = v + this.height * this.originY;
        },
      },
      ...
      right: {
        ...
        "set": function (v) {
          this.x = v - this.width * (1 - this.originX);
        },
      },
      ...
      bottom: {
        ...
        "set": function (v) {
          this.y = v - this.height * (1 - this.originY);
        },
      },
      ...
      left: {
        ...
        "set": function (v) {
          this.x = v + this.width * this.originX;
        },
      },
